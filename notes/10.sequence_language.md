...
\[
\frac{\partial \mathcal{L}}{\partial \mathbf{W_o}} = \sum_{t=1}^{T} \frac{\partial \ell}{\partial \mathbf{o}_t} \frac{\partial \mathbf{o}_t}{\partial \mathbf{W_o}}
\]
...
Since $\mathbf{h}_t = \phi(\mathbf{W_h} \mathbf{h}_{t-1} + \mathbf{W_x} \mathbf{x}_t + \mathbf{b})$, we get:
